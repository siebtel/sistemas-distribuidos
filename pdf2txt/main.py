...
def pdf2image(file_name):
	...
	file_name = file_name[13:-5] # retirando extensao e raiz da pasta do arquivo original
	...
	for page in pages:
		...
		ouput_filename = ".\\pdf2txt\\temp_images\\" +str(file_name)+"_page_"+str(image_counter)+".jpeg"
